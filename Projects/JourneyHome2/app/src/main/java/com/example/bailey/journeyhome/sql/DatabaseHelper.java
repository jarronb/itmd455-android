...
import static com.example.bailey.journeyhome.activities.RegisterActivity.getMD5;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            + COLUMN_USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_USER_TYPE + " TEXT,"
    ...
    public boolean checkUser(String email, String password) {
        ...
        // selection arguments
        String[] selectionArgs = {email, hashed_password};
