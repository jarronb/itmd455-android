...
//            startActivity(accountsIntent);
            User user = databaseHelper.getRoleByEmail(textInputEditTextEmail.getText().toString().trim());
            String userRole = user.getType().toUpperCase();
...
//            alert.setMessage("email pswd does not match");
